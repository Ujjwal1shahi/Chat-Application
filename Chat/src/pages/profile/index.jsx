        ...
        <div className="grid grid-cols-2">
            ...
            <Avatar className="h-32 w-32 md:w-48 md:h-48 rounded-full overflow-hidden">
              {
                ...
                <div className={`uppercase h-32 w-32 md:w-48 md:48 text-5xl border-[1px] flex items-center justify-center rounded-full ${getColor(selectedColor)}`}>
          ...
          <div className="flex min-w-32 md:min-w-64 flex-col gap-5 text-white items-center justify-center">
            ...
            <div className="w-full flex gap-5">
              {
                colors.map((colors, index) => <div className={`${colors} h-8 w-8 rounded-full cursor-pointer transition-all duration-200 
                 ${selectedColor === index ? "outline outline-white/70 outline-3" : 
                  " "
                 } `} 
                key={index}
